        ...
        <td style="padding: 16px;">
            <div style="width: 500px; max-width: 100%; margin: auto;">
                <a aria-label="home_page_link"
                    ...
                    <img src="{{ asset('img/logo.png') }}?v={{ env('APP_VERSION') }}" style="width: 100%; display: block;" />
                </a>
                ...
                <div
                    style="border-radius: 6px;background: rgb(223 168 114);width: max-content;margin: auto;
                ">
