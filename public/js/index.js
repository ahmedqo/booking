    ...
    Neo.Component({
        ...
        rules: {
            print(e) {
                if (this.props.blank) {
                    e.preventDefault();
                    window.open(e.target.href, '_blank', 'popup=true');
                }
            }
        },
        cycle: {
            mounted() {
                ...
                if (this.hasAttribute("blamk")) {
                    this.props.blamk = this.getAttribute("blamk");
                    this.removeAttribute("blamk");
                }
